##################################################################################
# This code was adapted using the https://github.com/oduerr/dl_tutorial/tree/master/tensorflow/inception_cifar10
################################################################################
"""
	This script extracts Cifar10 features from the pretrained Incepcion v3 model
"""
...
def extract_features(file_name):
    d = unpickle(os.path.join(os.path.expanduser('/home/kyp/tooploox/MyProject/cifar-10-batches-py/'), file_name))
    data = d['data']
